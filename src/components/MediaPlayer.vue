...
export default {
  ...
  props: {
    ...
    autopictureinpicture: { type: Boolean, required: false, default: false }, // Start with picture in picture mode
    ...
    disablepictureinpicture: { type: Boolean, required: false, default: true }, // Shows the picture in picture button
    disableremoteplayback: { type: Boolean, required: false, default: true }, // Shows the remote playback button but functionality does not exist when clicked
    height: { type: String, required: false, default: "auto" },
    width: { type: String, required: false, default: "100%" },
    rewind: { type: Boolean, required: false, default: true }, // Enabled the rewind 10s button
  ...
  methods: {
    ...
    onRemoteplayback(el) {
      ...
      el.remote
        .prompt()
        .then(() => {
          this.$toast.info("Remote playback not implemented on this player");
        })
        .catch((e) => {
